...
//           We use smart alliances and open communication. We are committed to minimizing 
...
//             <div
//               key={index}
//               className="text-center p-8 bg-gradient-to-br from-green-50 to-blue-50 rounded-lg hover:shadow-lg transition-shadow"
//             >
